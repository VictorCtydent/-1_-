...
# первый запрос (POST)
url = 'http://127.0.0.1:5000//v1/add/tax'
data = {
    'reg_id': 35,
    'tax_rate': 45
}
...
# второй запрос (GET)
url_1 = 'http://127.0.0.1:5000//v1/fetch/taxes'
...
# третий запрос (GET)
url_2 = 'http://127.0.0.1:5000//v1/fetch/tax'
data_1 = {
    'reg_id': 35
}
...
url_3 = 'http://127.0.0.1:5000//v1/fetch/calc'
data_2 = {
    'reg_id': 35,
    'mounth': 10,
    'price': 120
...
url_4 = 'http://127.0.0.1:5000//v1/update/tax'
data_3 = {
    'reg_id': 35,
    'tax_rate': 7,
}
